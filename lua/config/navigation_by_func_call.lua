...
vim.keymap.set('n', '<localleader>n', move_to_next_valid_identifier, { desc = 'Move to [N]ext valid identifier' })
vim.keymap.set('n', '<localleader>p', move_to_previous_valid_identifier, { desc = 'Move to [P]revious valid identifier' })
